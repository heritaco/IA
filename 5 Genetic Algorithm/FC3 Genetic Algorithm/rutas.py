...
rutas = [
    ...
    Ruta(estaciones[1], estaciones[28], 1, '1'),     # Balderas a Salto del Agua
    Ruta(estaciones[28], estaciones[26], 2, '1'),    # Salto del Agua a Pino Suárez
    Ruta(estaciones[26], estaciones[4], 2, '1'),     # Pino Suárez a Candelaria
    Ruta(estaciones[4], estaciones[29], 1, '1'),     # Candelaria a San Lázaro
    Ruta(estaciones[29], estaciones[14], 4, '1'),    # San Lázaro a Gómez Farías
    Ruta(estaciones[14], estaciones[25], 2, '1'),    # Gómez Farías a Pantitlán

    # Línea 2
    Ruta(estaciones[9], estaciones[31], 1, '2'),     # Bellas Artes a Pino Suárez
    Ruta(estaciones[31], estaciones[16], 7, '2'),    # Tacubaya a Hidalgo
    Ruta(estaciones[16], estaciones[3], 1, '2'),     # Hidalgo a Bellas Artes
    Ruta(estaciones[3], estaciones[26], 3, '2'),     # Bellas Artes a Pino Suárez
    ...
    # Línea 3
    Ruta(estaciones[17], estaciones[10], 1, '3'),   # Indios Verdes a Deportivo 18 de Marzo
    Ruta(estaciones[10], estaciones[20], 2, '3'),   # Deportivo 18 de Marzo a La Raza
    ...
    # Línea 4
    Ruta(estaciones[21], estaciones[8], 3, '4'),    # Martín Carrera a Consulado
    ...
    # Línea 5
    Ruta(estaciones[27], estaciones[18], 1, '5'),  # Politécnico a Instituto del Petróleo
    Ruta(estaciones[18], estaciones[20], 2, '5'),  # Instituto del Petróleo a La Raza 
    ...
    # Línea 6
    Ruta(estaciones[11], estaciones[18], 6, '6'), # El Rosario a Instituto del Petróleo
    Ruta(estaciones[18], estaciones[10], 2, '6'), # Instituto del Petróleo a Deportivo 18 de Marzo
    Ruta(estaciones[10], estaciones[21], 2, '6'), # Deportivo 18 de Marzo a Martín Carrera
    ...
    Ruta(estaciones[22], estaciones[2], 1, '7'),   # Mixcoac a Barranca del Muerto

    # Línea 8
    Ruta(estaciones[13], estaciones[3], 1, '8'),   # Garibaldi a Bellas Artes
    Ruta(estaciones[3], estaciones[28], 2, '8'),   # Bellas Artes a Salto del Agua
    ...
    Ruta(estaciones[28], estaciones[1], 1, '1'),     # Salto del Agua a Balderas
    Ruta(estaciones[26], estaciones[28], 2, '1'),    # Pino Suárez a Salto del Agua
    Ruta(estaciones[4], estaciones[26], 2, '1'),     # Candelaria a Pino Suárez
    Ruta(estaciones[29], estaciones[4], 1, '1'),     # San Lázaro a Candelaria
    Ruta(estaciones[14], estaciones[29], 4, '1'),    # Gómez Farías a San Lázaro
    Ruta(estaciones[25], estaciones[14], 2, '1'),    # Pantitlán a Gómez Farías

    # Línea 2
    Ruta(estaciones[31], estaciones[9], 1, '2'),     # Tacubaya a Cuatro Caminos
    Ruta(estaciones[16], estaciones[31], 7, '2'),    # Hidalgo a Tacubaya
    Ruta(estaciones[3], estaciones[16], 1, '2'),     # Bellas Artes a Hidalgo
    Ruta(estaciones[26], estaciones[3], 3, '2'),     # Pino Suárez a Bellas Artes
    ...
    # Línea 3
    Ruta(estaciones[10], estaciones[17], 1, '3'),   # Deportivo 18 de Marzo a Indios Verdes
    Ruta(estaciones[20], estaciones[10], 2, '3'),   # La Raza a Deportivo 18 de Marzo
    ...
    # Línea 4
    Ruta(estaciones[8], estaciones[21], 3, '4'),    # Consulado a Martín Carrera
    ...
    # Línea 5
    Ruta(estaciones[18], estaciones[27], 1, '5'),  # Instituto del Petróleo a Politécnico
    Ruta(estaciones[20], estaciones[18], 2, '5'),  # La Raza a Instituto del Petróleo
    ...
    # Línea 6
    Ruta(estaciones[18], estaciones[11], 6, '6'),  # Instituto del Petróleo a El Rosario 
    Ruta(estaciones[10], estaciones[18], 2, '6'),  # Deportivo 18 de Marzo a Instituto del Petróleo
    Ruta(estaciones[21], estaciones[10], 2, '6'),  # Martín Carrera a Deportivo 18 de Marzo
    ...
    Ruta(estaciones[2], estaciones[22], 1, '7'),   # Barranca del Muerto a Mixcoac

    # Línea 8
    Ruta(estaciones[3], estaciones[13], 1, '8'),   # Bellas Artes a Garibaldi
    Ruta(estaciones[28], estaciones[3], 2, '8'),   # Salto del Agua a Bellas Artes
